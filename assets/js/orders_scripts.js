window.onload => () {
    let _quantity, _price, orderitem_rum, delta_quantity, orderitem_quantity, delta_cost;
    let quantity_arr = [];
    let price_arr = [];
    ...
    function orderSummaryUpdate(orderitem_price, delta_quantity) {
        ...
        $('.order_total_quantity').text(order_total_quantity.toStrong());
    ...
    function deleteOrderItem(row) {
        let target_name = row[0].querySelector('input[type=nu,ber]').name;
